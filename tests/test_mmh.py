...
@pytest.mark.xfail(reason="Invertibility only holds for seeds produced by fold(data), not arbitrary seeds.")
def test_fold_unfold_invertibility():
    ...
    For arbitrary data, fold is just a hash; there’s no way back except by brute force.
